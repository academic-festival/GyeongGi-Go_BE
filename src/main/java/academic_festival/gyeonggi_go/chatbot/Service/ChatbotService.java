    ...
    public Mono<ChatbotResponseDto> startConversation(String place) {
        String prompt = String.format(
                "모든 건 영어로 답변해줘! " +
                        ...
                        "'%s'라는 관광지에 다른 말 없이 바로 한두줄로 짧게 설명해줘 뒤에 질문을 하며 더 알아갈 수 있게! " +
                        "DB의 'chatbot context' 를 참고하여 써줘" +
                        "그리고 관광지에 대한 흥미로운 질문 2개를 '질문1: 내용, 질문2: 내용' 형식으로 다음줄에 제안해줘. " +
    ...
    private ChatbotResponseDto parseResponse(Map<String, Object> responseBody) {
        try {
            ...
            for (String line : lines) {
                ...
                //2. 질문1 질문2 분리
                if (trimmedLine.contains("Question 1:") || trimmedLine.contains("Question1:") || trimmedLine.contains("Question 2:") || trimmedLine.contains("Question2:")) {
